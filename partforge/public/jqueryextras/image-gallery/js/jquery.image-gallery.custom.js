            ...
            galleryOptions = $.extend(
                ...
                galleryWidget.data(),
                {
                    ...
                    onslide: function (index, slide) {
                        ...
                        // Begin mod for PartForge
                        // Take the image url and remove the part that makes it only medium size
                        var urlwithnoparams = $(slide).find("img").attr("src").split('?')[0];
                        $(dialogWidget).find(".title").html('<a href="'+urlwithnoparams+'" target="_blank">Open in New Window</a>');
                        // End mod for PartForge
