        ...
        if ($ItemVersion->getRecordById($this->params['id'])) {
            switch ($fmt) {
                ...
                case 'pdfnested':
                    ...
                    $Pdf->dbtable = $ItemVersion;
                    $Pdf->buildDocument($this->params);
                    $filesuff = $ItemVersion->hasASerialNumber() ? $ItemVersion->item_serial_number : time_to_mysqldatetime(strtotime((string) $ItemVersion->effective_date));
                ...
                case 'nested':
                    ...
                    break;
                case 'sheet':
                    $ReportData = new ReportDataItemListView(true, true, $ItemVersion->hasADisposition(), false, array('view_category' => $ItemVersion->tv__typeobject_id, 'itemversion_id' => $ItemVersion->itemversion_id));
