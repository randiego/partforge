...
class ReportDataUser extends ReportDataWithCategory {
	...
	public function make_directory_detail(&$queryvars, &$record,&$buttons_arr,&$detail_out,UrlCallRegistry $navigator) {
		...
		if (!$record['user_enabled']) $detail_out['login_id'] .= '<br /><span class="errorred">Login Not Enabled</span>';
		if ($record['waiting_approval']) $detail_out['login_id'] .= '<br /><span class="errorred">Waiting Approval</span>';
	}
