                ...
                case isset($this->params['btnLogin']):
                    ...
                    if ($_SESSION['account']->login($this->params['loginid'], $plainpw)) {
                        ...
                        if ($_SESSION['account']->has_temporary_password) {
                            ...
                            if (Zend_Registry::get('config')->allowed_to_keep_temp_pw) {
                                $buttonlist['Keep My Password'] = $this->navigator->getCurrentHandlerUrl('btnKeepPassword', 'changetemppassword', 'user');
                            }
            ...
            switch (true) {
                ...
                case isset($this->params['btnRequestResetFromAdmin']):
                    ...
                    if (!$User->contact_location) {
                        $errormsg[] = 'You need to specify contact information.';
                    }
                    $this->go_back_if_invalid_input($errormsg);
        ...
        if (isset($this->params['form'])) {
            switch (true) {
                case isset($this->params['btnOK']):
                    ...
                    if (isset($_SESSION['user_cryptpassword']) && $_SESSION['user_cryptpassword']) {
                ...
                case isset($this->params['btnOK']):
                    ...
                    try {
                        ...
                        foreach ($this->params['typeobject_id'] as $typeobject_id => $selected) {
                            if ($selected) {
                                $selected_typeobject_ids[] = $typeobject_id;
                            }
                        }
