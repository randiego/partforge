...
//        $fields_to_save_now = array($indexname);
        ...
        if (isset($this->params['parent_index'])) {
            $_SESSION[$edit_buffer]['parent_index'] = $this->params['parent_index'];
        }
...
//        }
 ...
 //                   $sub_params['return_url'] = $this->navigator->setCurrent(null,null,array('table' => $this->params['table']))->getCurrentViewUrl();
                ...
                $next_action = $sub_params['action'];
                unset($sub_params['action']);
                $next_controller = $sub_params['controller'];
                unset($sub_params['controller']);
