...
$config['cached_code_version'] = '187';  // for css and js files, this appended as ?v=N to the end to force reload to browse.  Increment when css or js files changes.
$config['databaseversion'] = '26';
